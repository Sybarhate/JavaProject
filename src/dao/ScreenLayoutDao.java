...
public class ScreenLayoutDao {
    ...
    public static void storeSeatNumbers(List<String> seatNumbers, int screenId) throws DAOException {
        try {
    ...
    public static List<ScreenLayout> fetchSeatNumbersFromDatabase(int id) throws DAOException {
